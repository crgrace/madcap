...
vlog -incr -sv "../src/prbs7.sv" 
vlog -incr "../src/datapath_fsm.sv" 
vlog -incr "../src/datapath.sv" 
vlog -incr "../src/event_router.sv" 
vlog +incdir+../testbench/larpix_tasks/ -incr "../src/data_packet_builder.sv" 
vlog +incdir+../testbench/larpix_tasks/ -incr "../src/config_packet_builder.sv" 
...
vlog +incdir+../testbench/larpix_tasks/ -incr "../src/comma_detect.sv" 
