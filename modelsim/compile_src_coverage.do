...
# Design sources
#
vlog -incr -cover bcefst "../src/register_map.v" 
#vlog -incr "../src/fifo.v" 
vlog -incr -cover bcefst "../src/fifo_async.v" 
vlog -incr -cover bcefst "../src/uart_rx.v" 
vlog -incr -cover bcefst "../src/uart_tx.v" 
vlog -incr -cover bcefst "../src/event_builder.v" 
vlog -incr -cover bcefst "../src/comms_ctrl.v" 
vlog -incr -cover bcefst "../src/fifo_rd_ctrl.v" 
vlog -incr -cover bcefst "../src/fifo_rd_ctrl_async.v" 
vlog -incr "../src/sar_ctrl.v"
vlog -incr "../src/sar_ctrl_rev1.v"
vlog -incr "../src/channel_id_encoder.v"
vlog -incr "../src/channel_ctrl.v"
vlog -incr -cover bcefst "../src/external_interface.v"
vlog -incr -cover bcefst "../src/time_stamp_gen.v"
vlog -incr -cover bcefst "../src/periodic_reset.v"
vlog -incr -cover bcefst "../src/clk_div.v"
vlog -incr "../src/dff.v"
vlog -incr -cover bcefst "../src/digital_core.v"
vlog -incr -cover bcefst "../src/synchronizer.v"
vlog -incr -cover bcefst "../src/reset_sync.v"
vlog -incr -cover bcefst "../src/reset_mux.v"
